...
$CFG->dbtype    = _env('MOODLE_DOCKER_DBTYPE');
$CFG->dblibrary = 'native';
$CFG->dbhost    = _env('MOODLE_DOCKER_DBHOST');
$CFG->dbname    = _env('MOODLE_DOCKER_DBNAME');
$CFG->dbuser    = _env('MOODLE_DOCKER_DBUSER');
$CFG->dbpass    = _env('MOODLE_DOCKER_DBPASS');
$CFG->prefix    = 'm_';
